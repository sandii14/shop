    ...
    <h1 data-aos="zoom-in">Guitar</h1>
        ...
        <div class="content">
            ...
            <?php
                include "../koneksi.php";
                $no = 1;
                $query = mysqli_query($koneksi, "SELECT * FROM `tb_barang` WHERE id_barang LIKE '%gitar%'" );   
            ...
            <div class="gitar" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="1400">
                <article>
                    <figure>
                        <a href="#">
                            <?php echo "<img src='../img/kategori/gitar/$data[image]' width='300' height='300' />";?>
