...
<head>
    ...
    <!-- Memanggil css ekternal style gitar -->
...
<section id="main">
    <!-- Judul -->
    <h1 data-aos="zoom-in">Microphones</h1>
    <!-- Content -->
    <div class="content">
        <!-- Code php menampilkan tb_barang like mic-->
        <?php
             include "../koneksi.php";
             $no = 1;
             $query = mysqli_query($koneksi, "SELECT * FROM `tb_barang` WHERE id_barang LIKE '%mic%'" );
        ...
        ?>
            <div class="gitar" data-aos="fade-up" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="1400">
                <article>
                    <figure>
                        <a href="#">
                            <?php echo "<img src='../img/kategori/mic/$data[image]' width='300' height='300' />";?>
